...
本文介绍如何使用 Function Mesh 创建 Java 函数。 
...
1. 使用 YAML 文件定义 Java 函数并保存 YAML 文件。 

   - 如下例子介绍如何使用名为 `function://my-tenant/my-ns/my-function@0.1` 的 JAR 包将 `java-function-sample` 函数发布到 Pulsar 集群。
   ...
   - 如下例子介绍如何使用 Docker 镜像将 `java-function-sample`  发布到 Pulsar 集群。
